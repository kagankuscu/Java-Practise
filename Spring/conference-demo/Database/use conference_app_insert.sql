...
--     FOREIGN KEY (ticket_type_code) REFERENCES ticket_types (ticket_type_code)

-- use conference_app
-- ALTER TABLE ticket_prices
--     DROP CONSTRAINT fk_ticket_type

-- EXEC sp_fkeys 'ticket_prices'

INSERT INTO [dbo].[ticket_types] (ticket_type_code,ticket_type_name,[description],includes_workshop)
...
INSERT INTO [dbo].[pricing_categories] (pricing_category_code,pricing_category_name,pricing_start_date,pricing_end_date)
VALUES ('E','Early Bird','2019-12-01','2020-01-15'),
       ('R','Regular','2020-01-16','2020-03-20'),
       ('L','Last Minute','2020-03-21','2020-04-07');

INSERT INTO [dbo].[ticket_prices] (ticket_price_id,ticket_type_code,pricing_category_code,base_price)
VALUES (1,'P','E',800),
       (2,'P','R',1000),
       (3,'P','L',1200),
       (4,'S','E',500),
...
INSERT INTO [dbo].[time_slots] (time_slot_id,time_slot_date,start_time,end_time,is_keynote_time_slot)
...
INSERT INTO [dbo].[sessions] (session_id,session_name,session_length,session_description)
...
INSERT INTO [dbo].[session_schedule] (schedule_id,time_slot_id,session_id,room)
...
INSERT INTO [dbo].[tags] (tag_id,description)
VALUES (1,'.NET'),
       (2,'Java'),
       (3,'Python'),
       (4,'JavaScript'),
...
INSERT INTO [dbo].[speakers] (speaker_id,first_name,last_name,title,company,speaker_bio,speaker_photo)
...
INSERT INTO [dbo].[session_speakers] (session_id,speaker_id)
VALUES (1,40),
       (2,4),
       (3,5),
       (4,1),
...
INSERT INTO [dbo].[workshops] (workshop_id,workshop_name,description,requirements,room,capacity)
